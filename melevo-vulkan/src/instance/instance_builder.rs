use super::{instance::InstanceInner, Instance};
...
impl InstanceBuilder {
	...
	pub fn set_app_name(mut self, app_name: impl Into<String>) -> Self {
		self.application_info.application_name = app_name.into();

		self
	}

	pub fn set_app_version(mut self, app_version: impl ToVulkanVersion) -> Self {
	...
	pub fn set_engine_name(mut self, engine_name: impl Into<String>) -> Self {
		self.application_info.engine_name = engine_name.into();

		self
	}

	pub fn set_engine_version(mut self, engine_version: impl ToVulkanVersion) -> Self {
	...
	pub fn require_api_version(mut self, api_version: impl ToVulkanVersion) -> Self {
	...
	pub fn enable_layer(mut self, layer: impl Into<String>) -> Self {
		self.instance_create_info.enabled_layers.push(layer.into());
	...
	pub fn enable_extension(mut self, extension: impl Into<String>) -> Self {
		self.instance_create_info.enabled_extensions.push(extension.into());
